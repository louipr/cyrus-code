...
describe('SourceFileManager', () => {
  ...
  it('should parse and return source files', () => {
    const sourceFile = manager.getSourceFile('src/services/source-tools/schema.ts');
  ...
  it('should cache source files', () => {
    const filePath = 'src/services/source-tools/schema.ts';
  ...
  it('should clear cache', () => {
    manager.getSourceFile('src/services/source-tools/schema.ts');
    assert.strictEqual(manager.cacheSize, 1);
